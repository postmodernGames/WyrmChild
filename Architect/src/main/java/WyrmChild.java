...
public class WyrmChild {
    ...
    static FileInputStream grammarFile = null;
    ...
    public static void main(String[] args) throws IOException {
        try {
            WyrmChild wyrmchild = new WyrmChild();
            Machine machine = new Machine();
            wyrmchild.tokenQueue = wyrmchild.tokenizeFile(machine, new FileInputStream(args[0]));


            out = new PrintWriter("C:\\Users\\grahamr9\\workspace\\Apiary\\output.txt");
            data = new PushbackInputStream(grammarFile);
        ...
        while (!quitFlag) {
            ...
            Parser.buildParseTree(Grammar, P, Parser.inputIndex);
    ...
    public LinkedList<String> tokenizeFile(Machine machine, FileInputStream infile) {
        machine.initialize();
        machine.run(infile);
        return machine.tokenQueue;
    }
